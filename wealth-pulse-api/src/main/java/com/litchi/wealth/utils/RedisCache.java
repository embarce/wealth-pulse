...
public class RedisCache {
     ...
     * @param timeout  时间
     */
    public <T> Boolean setIfAbsent(final String key, final T value, final Integer timeout) {
     ...
     * @param value
     */
    public void setAddValueByKey(String key, Object value) {
     ...
     * @return 递减后的值
     */
    public Long decrementHashValue(final String key, final String hKey, final long delta) {
        return redisTemplate.opsForHash().increment(key, hKey, -delta);
    }
